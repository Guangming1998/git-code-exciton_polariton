...
# else:
    ...
    CJJavg1_list,CJJavg_cav_list, CJJavg_mol_list = [model1.getCurrentCorrelation_ensemble(index=35)[2]], [model1.getCurrentCorrelation_ensemble(index=35)[1]], [model1.getCurrentCorrelation_ensemble(index=35)[0]]
    ...
    for i in range(Ntimes):
        ...
        if i%Nskip ==0:
            ...
            CJJavg_mol_list.append(model1.getCurrentCorrelation_ensemble(index=35)[0])
